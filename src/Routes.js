...
export const Routes = [
  {
    ...
    subNav: [
      ...
      },
      {
        ...
        path: "/Operator/FailedHistory/Read",
      ...
      },
      {
        ...
        path: "/Operator/LoginHistory/Read",

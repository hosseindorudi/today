...
import './partRequestDefine.css'

const PartRequestDefine = () => {
    ...
    <div className="periorityFormMain">
        <div className="periorityFormHeader"><h1>{t("PartRequestDefineHeader")}</h1></div>
...
export default PartRequestDefine
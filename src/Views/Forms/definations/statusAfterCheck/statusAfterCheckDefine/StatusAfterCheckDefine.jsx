...
import './statusAfterCheckDefine.css'

const StatusAfterCheckDefine = () => {
    ...
    <div className="periorityFormMain">
        <div className="periorityFormHeader"><h1>{t("StatusAfterCheckDefineHeader")}</h1></div>
...
export default StatusAfterCheckDefine
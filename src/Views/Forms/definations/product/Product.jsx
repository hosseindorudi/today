          ...
          <div className="groupContainerRight">
            ...
            <div className="reacttableParentMainRightDown">
              ...
              <div className="reacttableParentMainRightDownToolBoxDiv">
                ...
                {haveAccess(enums.Definition_Product_Export_r) && (
                  <ExportAllButton
                    numberOfRecordsPerPage={numberOfRecordsPerPage}
                    currentPage={currentPage}
                    sort={sort}
                    ...
                    seartEnd={seartEnd}
                    exportLink={productExport}
                  />
                )}
                {haveAccess(enums.Definition_Product_Import_w) && (
                  <ImportCSV importSuccess={importSuccess} sampleUrl={productSampleFile} fileCheckURL={productCheckFile} importURL={productImportFile}/>
                )}
                {haveAccess(enums.Definition_Product_Log_r) && (
                  <button
            ...
            <div className="tableSection">
              ...
              >
                <div className="reacttableParentPlusButton">
                  ...
                  {haveAccess(enums.Definition_Product_Create_w) && (
                        ...
                        <tbody>
                          {posts.map((post, index) => (
                            <tr key={index}>
                              ...
                              <TableButtons
                                  exportLink={productExportId}
                                  deleteType={enums.Definition_Product_Delete_w}
                                  editType={enums.Definition_Product_Update_w}
                                  exportType={enums.Definition_Product_Export_r}
                                  accessListType={
                                    ""
                                  }
                                  changePasswordType={

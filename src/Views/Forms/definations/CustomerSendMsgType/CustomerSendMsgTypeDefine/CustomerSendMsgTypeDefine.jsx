...
import './customerSendMsgTypeDefine.css'

const CustomerSendMsgTypeDefine = () => {
    ...
    <div className="periorityFormMain">
        <div className="periorityFormHeader"><h1>{t("sendCustomerMsgTypeDefineHeader")}</h1></div>
...
export default CustomerSendMsgTypeDefine
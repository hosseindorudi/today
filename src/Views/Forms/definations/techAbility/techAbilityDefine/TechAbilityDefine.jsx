...
import './techAbilityDefine.css'
const TechAbilityDefine = () => {
    ...
    <div className="periorityFormMain">
        <div className="periorityFormHeader"><h1>{t("TechAbilityDefineHeader")}</h1></div>
...
export default TechAbilityDefine
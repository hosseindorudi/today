...
import './statusAfterWorkDefine.css'
const StatusAfterWorkDefine = () => {
    ...
    <div className="periorityFormMain">
        <div className="periorityFormHeader"><h1>{t("StatusAfterWorkDefineHeader")}</h1></div>
...
export default StatusAfterWorkDefine
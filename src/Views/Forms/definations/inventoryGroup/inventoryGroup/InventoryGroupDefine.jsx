...
import './inventoryGroupDefine.css'

const InventoryGroupDefine = () => {
    ...
    <div className="periorityFormMain">
        <div className="periorityFormHeader"><h1>{t("InventoryGroupDefineHeader")}</h1></div>
...
export default InventoryGroupDefine
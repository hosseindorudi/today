...
const Accessories = () => {
  ...
  const readPaging = (paging) => {
    ...
    fetchData({
      method: "POST",
      url: admissionAccessoryReadPaging,
      headers: {
        accept: "*/*",
      },
      data: {
  ...
  const sendUnselectRequest = (temp) => {
    ...
    fetchData({
      method: "POST",
      url: admissionAccessorySetUnselectedColumn,
      headers: {
        accept: "*/*",
      },
      data: {
  ...
  const handleClickEdit = (id) => {
    ...
    fetchData({
      method: "POST",
      url: admissionAccessoryGetOneRecord,
      headers: {
        accept: "*/*",
      },
      data: {
  ...
  const handleClickFav = () => {
    ...
    fetchData({
      method: "POST",
      url: admissionAccessoryFavorite,
      headers: {
        accept: "*/*",
      },
      data: request,
  ...
  const handleClickAccessList = () => {
    ...
    fetchData({
      method: "POST",
      url: admissionAccessoryAccessList,
      headers: {
        accept: "*/*",
      },
      data: request,
          ...
          <div className="groupContainerRight">
            ...
            <div className="reacttableParentMainRightDown">
              ...
              <div className="reacttableParentMainRightDownToolBoxDiv">
                ...
                {haveAccess(enums.Definition_AdmissionAccessory_Export_r) && (
                  <ExportAllButton
                    numberOfRecordsPerPage={numberOfRecordsPerPage}
                    currentPage={currentPage}
                    sort={sort}
                ...
                {haveAccess(enums.Definition_AdmissionAccessory_Import_w) && (
                  <ImportCSV importSuccess={importSuccess} sampleUrl={admissionAccessorySampleFile} fileCheckURL={admissionAccessoryCheckFile} importURL={admissionAccessoryImportFile}/>
                )}
                {haveAccess(enums.Definition_AdmissionAccessory_Log_r) && (
                  <button
            ...
            <div className="tableSection">
              ...
              >
                <div className="reacttableParentPlusButton">
                  ...
                  {haveAccess(enums.Definition_AdmissionAccessory_Create_w) && (
                        ...
                        <tbody>
                          {posts.map((post, index) => (
                            <tr key={index}>
                              ...
                              <TableButtons
                                  exportLink={admissionAccessoryExportId}
                                  deleteType={enums.Definition_AdmissionAccessory_Delete_w}
                                  editType={enums.Definition_AdmissionAccessory_Update_w}
                                  exportType={enums.Definition_AdmissionAccessory_Export_r}
                                  accessListType={
                                    ""
                                  }
                                  changePasswordType={

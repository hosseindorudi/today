...
const Parts = () => {
  const filteredColumns = ["IsLimited", "Id", "Registrar","Product_Id","Language_EId","SourceType"];
          ...
          <div className="groupContainerRight">
            ...
            <div className="reacttableParentMainRightDown">
              ...
              <div className="reacttableParentMainRightDownToolBoxDiv">
                ...
                {haveAccess(enums.Definition_Part_Export_r) && (
                  <ExportAllButton
                    numberOfRecordsPerPage={numberOfRecordsPerPage}
                    currentPage={currentPage}
                    sort={sort}
                ...
                {haveAccess(enums.Definition_Part_Import_w) && (
                  <ImportCSV importSuccess={importSuccess} sampleUrl={PartSampleFile} fileCheckURL={PartCheckFile} importURL={PartImportFile}/>
                )}
                {haveAccess(enums.Definition_Part_Log_r) && (
                  <button
            ...
            <div className="tableSection">
              ...
              >
                <div className="reacttableParentPlusButton">
                  ...
                  {haveAccess(enums.Definition_Part_Create_w) && (
                        ...
                        <tbody>
                          {posts.map((post, index) => (
                            <tr key={index}>
                              ...
                              <TableButtons
                                  exportLink={PartExportId}
                                  deleteType={enums.Definition_Part_Delete_w}
                                  editType={enums.Definition_Part_Update_w}
                                  exportType={enums.Definition_Part_Export_r}
                                  accessListType={
                                    ""
                                  }
                                  changePasswordType={

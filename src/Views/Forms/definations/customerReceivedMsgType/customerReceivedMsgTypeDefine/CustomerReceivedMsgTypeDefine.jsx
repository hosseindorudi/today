...
import './customerReceivedMsgTypeDefine.css'
const CustomerReceivedMsgTypeDefine = () => {
    ...
    <div className="periorityFormMain">
        <div className="periorityFormHeader"><h1>{t("receivedCustomerMsgTypeDefineHeader")}</h1></div>
...
export default CustomerReceivedMsgTypeDefine
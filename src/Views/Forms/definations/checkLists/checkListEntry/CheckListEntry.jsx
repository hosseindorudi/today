...
import CheckListEntryFormDefine from './checkListEntryForm/CheckListEntryFormDefine'
import { inputQualityControlAccessList, inputQualityControlCheckFile, inputQualityControlDelete, inputQualityControlExport, inputQualityControlExportId, inputQualityControlFavorite, inputQualityControlGetOneRecord, inputQualityControlImportFile, inputQualityControlLog, inputQualityControlRead, inputQualityControlReadPaging, inputQualityControlSampleFile, inputQualityControlSetUnselectedColumn } from "../../../../../services/inputQualityControlService";
const CheckListEntry = () => {
  ...
  const readPaging = (paging) => {
    ...
    fetchData({
      method: "POST",
      url: inputQualityControlReadPaging,
      headers: {
        accept: "*/*",
      },
      data: {
  ...
  const sendUnselectRequest = (temp) => {
    ...
    fetchData({
      method: "POST",
      url: inputQualityControlSetUnselectedColumn,
      headers: {
        accept: "*/*",
      },
      data: {
  ...
  const handleClickEdit = (id) => {
    ...
    fetchData({
      method: "POST",
      url: inputQualityControlGetOneRecord,
      headers: {
        accept: "*/*",
      },
      data: {
  ...
  const handleClickFav = () => {
    ...
    fetchData({
      method: "POST",
      url: inputQualityControlFavorite,
      headers: {
        accept: "*/*",
      },
      data: request,
  ...
  const handleClickAccessList = () => {
    ...
    fetchData({
      method: "POST",
      url: inputQualityControlAccessList,
      headers: {
        accept: "*/*",
      },
      data: request,
          ...
          <div className="groupContainerRight">
            ...
            <div className="reacttableParentMainRightDown">
              ...
              <div className="reacttableParentMainRightDownToolBoxDiv">
                ...
                {haveAccess(enums.Definition_InputQualityControl_Export_r) && (
                  <ExportAllButton
                    numberOfRecordsPerPage={numberOfRecordsPerPage}
                    currentPage={currentPage}
                    sort={sort}
                ...
                {haveAccess(enums.Definition_InputQualityControl_Import_w) && (
                  <ImportCSV importSuccess={importSuccess} sampleUrl={inputQualityControlSampleFile} fileCheckURL={inputQualityControlCheckFile} importURL={inputQualityControlImportFile}/>
                )}
                {haveAccess(enums.Definition_InputQualityControl_Log_r) && (
                  <button
            ...
            <div className="tableSection">
              ...
              >
                <div className="reacttableParentPlusButton">
                  ...
                  {haveAccess(enums.Definition_InputQualityControl_Create_w) && (
                        ...
                        <tbody>
                          {posts.map((post, index) => (
                            <tr key={index}>
                              ...
                              <TableButtons
                                  exportLink={inputQualityControlExportId}
                                  deleteType={enums.Definition_InputQualityControl_Delete_w}
                                  editType={enums.Definition_InputQualityControl_Update_w}
                                  exportType={enums.Definition_InputQualityControl_Export_r}
                                  accessListType={
                                    ""
                                  }
                                  changePasswordType={

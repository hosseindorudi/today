...
import CheckListExitFormDefine from "./checkListExitFormDefine/CheckListExitFormDefine";
...
const CheckListExit = () => {
  ...
  const readPaging = (paging) => {
    ...
    fetchData({
      method: "POST",
      url: outputQualityControlReadPaging,
      headers: {
        accept: "*/*",
      },
      data: {
  ...
  const sendUnselectRequest = (temp) => {
    ...
    fetchData({
      method: "POST",
      url: outputQualityControlSetUnselectedColumn,
      headers: {
        accept: "*/*",
      },
      data: {
  ...
  const deleteRecord = (id) => {
    ...
    fetchData({
      method: "POST",
      url: outputQualityControlDelete,
      headers: {
        accept: "*/*",
      },
      data: {
  ...
  const handleClickEdit = (id) => {
    ...
    fetchData({
      method: "POST",
      url: outputQualityControlGetOneRecord,
      headers: {
        accept: "*/*",
      },
      data: {
  ...
  const handleClickFav = () => {
    ...
    fetchData({
      method: "POST",
      url: outputQualityControlFavorite,
      headers: {
        accept: "*/*",
      },
      data: request,
  ...
  const handleClickAccessList = () => {
    ...
    fetchData({
      method: "POST",
      url: outputQualityControlAccessList,
      headers: {
        accept: "*/*",
      },
      data: request,
          ...
          <div className="groupContainerRight">
            ...
            <div className="reacttableParentMainRightDown">
              ...
              <div className="reacttableParentMainRightDownToolBoxDiv">
                ...
                {haveAccess(enums.Definition_OutputQualityControl_Export_r) && (
                  <ExportAllButton
                    numberOfRecordsPerPage={numberOfRecordsPerPage}
                    currentPage={currentPage}
                    sort={sort}
                ...
                {haveAccess(enums.Definition_OutputQualityControl_Import_w) && (
                  <ImportCSV importSuccess={importSuccess} sampleUrl={outputQualityControlSampleFile} fileCheckURL={outputQualityControlCheckFile} importURL={outputQualityControlImportFile}/>
                )}
                {haveAccess(enums.Definition_OutputQualityControl_Log_r) && (
                  <button
            ...
            <div className="tableSection">
              ...
              >
                <div className="reacttableParentPlusButton">
                  ...
                  {haveAccess(enums.Definition_OutputQualityControl_Create_w) && (
                        ...
                        <tbody>
                          {posts.map((post, index) => (
                            <tr key={index}>
                              ...
                              <TableButtons
                                  exportLink={outputQualityControlExportId}
                                  deleteType={enums.Definition_OutputQualityControl_Delete_w}
                                  editType={enums.Definition_OutputQualityControl_Update_w}
                                  exportType={enums.Definition_OutputQualityControl_Export_r}
                                  accessListType={
                                    ""
                                  }
                                  changePasswordType={

...
const WarrantyType = () => {
  ...
  const sendUnselectRequest = (temp) => {
    ...
    fetchData({
      method: "POST",
      url: warrantyTypeSetUnselectedColumn,
      headers: {
        accept: "*/*",
      },
      data: {
          ...
          <div className="groupContainerRight">
            ...
            <div className="reacttableParentMainRightDown">
              ...
              <div className="reacttableParentMainRightDownToolBoxDiv">
                ...
                {haveAccess(enums.Definition_WarrantyType_Export_r) && (
                  <ExportAllButton
                    numberOfRecordsPerPage={numberOfRecordsPerPage}
                    currentPage={currentPage}
                    sort={sort}
                ...
                {haveAccess(enums.Definition_WarrantyType_Import_w) && (
                  <ImportCSV importSuccess={importSuccess} sampleUrl={warrantyTypeSampleFile} fileCheckURL={warrantyTypeCheckFile} importURL={warrantyTypeImportFile}/>
                )}
                {haveAccess(enums.Definition_WarrantyType_Log_r) && (
                  <button
                ...
                {haveAccess(enums.Definition_WarrantyType_Read_r) && (
                <button
            ...
            <div className="tableSection">
              ...
              >
                <div className="reacttableParentPlusButton">
                  ...
                  {haveAccess(enums.Definition_WarrantyType_Create_w) && (
                        ...
                        <tbody>
                          {posts.map((post, index) => (
                            <tr key={index}>
                              ...
                              <TableButtons
                                  exportLink={warrantyTypeExportId}
                                  deleteType={enums.Definition_WarrantyType_Delete_w}
                                  editType={enums.Definition_WarrantyType_Update_w}
                                  exportType={enums.Definition_WarrantyType_Export_r}
                                  accessListType={
                                    ""
                                  }
                                  changePasswordType={

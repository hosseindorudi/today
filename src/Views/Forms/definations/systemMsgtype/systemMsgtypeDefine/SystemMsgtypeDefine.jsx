...
import './systemMsgtypeDefine.css'
const SystemMsgtypeDefine = () => {
    ...
    <div className="periorityFormMain">
        <div className="periorityFormHeader"><h1>{t("SystemMsgtypeDefineHeader")}</h1></div>
...
export default SystemMsgtypeDefine
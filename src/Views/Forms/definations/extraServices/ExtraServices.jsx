...
const ExtraServices = () => {
  ...
  const readPaging = (paging) => {
    ...
    fetchData({
      method: "POST",
      url: additionalServiceReadPaging,
      headers: {
        accept: "*/*",
      },
      data: {
  ...
  const sendUnselectRequest = (temp) => {
    ...
    fetchData({
      method: "POST",
      url: additionalServiceSetUnselectedColumn,
      headers: {
        accept: "*/*",
      },
      data: {
  ...
  const handleClickEdit = (id) => {
    ...
    fetchData({
      method: "POST",
      url: additionalServiceGetOneRecord,
      headers: {
        accept: "*/*",
      },
      data: {
  ...
  const handleClickAccessList = () => {
    ...
    fetchData({
      method: "POST",
      url: additionalServiceAccessList,
      headers: {
        accept: "*/*",
      },
      data: request,
          ...
          <div className="groupContainerRight">
            ...
            <div className="reacttableParentMainRightDown">
              ...
              <div className="reacttableParentMainRightDownToolBoxDiv">
                ...
                {haveAccess(enums.Definition_AdditionalService_Export_r) && (
                  <ExportAllButton
                    numberOfRecordsPerPage={numberOfRecordsPerPage}
                    currentPage={currentPage}
                    sort={sort}
                ...
                {haveAccess(enums.Definition_AdditionalService_Import_w) && (
                  <ImportCSV importSuccess={importSuccess} sampleUrl={additionalServiceSampleFile} fileCheckURL={additionalServiceCheckFile} importURL={additionalServiceImportFile}/>
                )}
                {haveAccess(enums.Definition_AdditionalService_Log_r) && (
                  <button
                ...
                {haveAccess(enums.Definition_AdditionalService_Read_r) && (
                <button
            ...
            <div className="tableSection">
              ...
              >
                <div className="reacttableParentPlusButton">
                  ...
                  {haveAccess(enums.Definition_AdditionalService_Create_w) && (
                        ...
                        <tbody>
                          {posts.map((post, index) => (
                            <tr key={index}>
                              ...
                              <TableButtons
                                  exportLink={additionalServiceExportId}
                                  deleteType={enums.Definition_AdditionalService_Delete_w}
                                  editType={enums.Definition_AdditionalService_Update_w}
                                  exportType={enums.Definition_AdditionalService_Export_r}
                                  accessListType={
                                    ""
                                  }
                                  changePasswordType={

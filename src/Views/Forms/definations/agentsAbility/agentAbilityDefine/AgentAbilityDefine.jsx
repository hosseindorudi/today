...
import './agentAbilityDefine.css'
const AgentAbilityDefine = () => {
...
<div className="periorityFormMain">
    <div className="periorityFormHeader"><h1>{t("agentAbilityDefineHeader")}</h1></div>
...
export default AgentAbilityDefine
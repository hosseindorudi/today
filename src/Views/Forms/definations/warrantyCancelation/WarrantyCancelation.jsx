...
const WarrantyCancelation = () => {
  ...
  const getTable = () => {
    fetchData({
      method: "POST",
      url:reasonForCancellationOfWarrantyRead,
      headers: {
        accept: "*/*",
      },
      data: request,
  ...
  const readPaging = (paging) => {
    ...
    fetchData({
      method: "POST",
      url: reasonForCancellationOfWarrantyReadPaging,
      headers: {
        accept: "*/*",
      },
      data: {
  ...
  const sendUnselectRequest = (temp) => {
    ...
    fetchData({
      method: "POST",
      url: reasonForCancellationOfWarrantySetUnselectedColumn,
      headers: {
        accept: "*/*",
      },
      data: {
  ...
  const deleteRecord = (id) => {
    ...
    fetchData({
      method: "POST",
      url: reasonForCancellationOfWarrantyDelete,
      headers: {
        accept: "*/*",
      },
      data: {
  ...
  const handleClickEdit = (id) => {
    ...
    fetchData({
      method: "POST",
      url: reasonForCancellationOfWarrantyGetOneRecord,
      headers: {
        accept: "*/*",
      },
      data: {
  ...
  const handleClickFav = () => {
    ...
    fetchData({
      method: "POST",
      url: reasonForCancellationOfWarrantyFavorite,
      headers: {
        accept: "*/*",
      },
      data: request,
  ...
  const handleClickLog = () => {
    ...
    fetchData({
      method: "POST",
      url: reasonForCancellationOfWarrantyLog,
      headers: {
        accept: "*/*",
      },
      data: request,
  ...
  const handleClickAccessList = () => {
    ...
    fetchData({
      method: "POST",
      url: reasonForCancellationOfWarrantyAccessList,
      headers: {
        accept: "*/*",
      },
      data: request,
          ...
          <div className="groupContainerRight">
            ...
            <div className="reacttableParentMainRightDown">
              ...
              <div className="reacttableParentMainRightDownToolBoxDiv">
                ...
                {haveAccess(enums.Definition_ReasonForCancellationOfWarranty_Export_r) && (
                  <ExportAllButton
                    numberOfRecordsPerPage={numberOfRecordsPerPage}
                    currentPage={currentPage}
                    sort={sort}
                ...
                {haveAccess(enums.Definition_ReasonForCancellationOfWarranty_Import_w) && (
                  <ImportCSV importSuccess={importSuccess} sampleUrl={reasonForCancellationOfWarrantySampleFile} fileCheckURL={reasonForCancellationOfWarrantyCheckFile} importURL={reasonForCancellationOfWarrantyImportFile}/>
                )}
                {haveAccess(enums.Definition_ReasonForCancellationOfWarranty_Log_r) && (
                  <button
                ...
                {haveAccess(enums.Definition_AdmissionAccessory_Read_r) && (
                <button
            ...
            <div className="tableSection">
              ...
              >
                <div className="reacttableParentPlusButton">
                  ...
                  {haveAccess(enums.Definition_ReasonForCancellationOfWarranty_Create_w) && (
                        ...
                        <tbody>
                          {posts.map((post, index) => (
                            <tr key={index}>
                              ...
                              <TableButtons
                                  exportLink={reasonForCancellationOfWarrantyExportId}
                                  deleteType={enums.Definition_ReasonForCancellationOfWarranty_Delete_w}
                                  editType={enums.Definition_ReasonForCancellationOfWarranty_Update_w}
                                  exportType={enums.Definition_ReasonForCancellationOfWarranty_Export_r}
                                  accessListType={
                                    ""
                                  }
                                  changePasswordType={

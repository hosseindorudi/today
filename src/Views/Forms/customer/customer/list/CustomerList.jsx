...
const CustomerList = () => {
  ...
  const sendUnselectRequest = (temp) => {
    ...
    fetchData({
      method: "POST",
      url: customerSetUnselectedColumn,
      headers: {
        accept: "*/*",
      },
      data: {
          ...
          <div className="groupContainerRight">
            ...
            <div className="reacttableParentMainRightDown">
              ...
              <div className="reacttableParentMainRightDownToolBoxDiv">
                ...
                {haveAccess(enums.Customer_Customer_Export_r) && (
                  <ExportAllButton
                    numberOfRecordsPerPage={numberOfRecordsPerPage}
                    currentPage={currentPage}
                    sort={sort}
                ...
                {haveAccess(enums.Customer_Customer_Import_w) && (
                  <ImportCSV importSuccess={importSuccess} sampleUrl={customerSampleFile} fileCheckURL={customerCheckFile} importURL={customerImportFile}/>
                )}
                {haveAccess(enums.Customer_Customer_Log_r) && (
                  <button
            ...
            <div className="tableSection">
              ...
              >
                <div className="reacttableParentPlusButton">
                  ...
                  {haveAccess(enums.Customer_Customer_Create_w) && (
                        ...
                        <tbody>
                          {posts.map((post, index) => (
                            <tr key={index}>
                              ...
                              <TableButtons
                                  exportLink={customerExportId}
                                  deleteType={enums.Customer_Customer_Delete_w}
                                  editType={enums.Customer_Customer_Update_w}
                                  exportType={enums.Customer_Customer_Export_r}
                                  accessListType={
                                    ""
                                  }
                                  changePasswordType={
                                    enums.Customer_Customer_ChangePassword_w
                                  }

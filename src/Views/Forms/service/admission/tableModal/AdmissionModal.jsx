  ...
  const handleSubmit = (e) => {
    ...
    fetchData({
      ...
      data: {
        ...
        Customer_Signature: sigCustomerEdit
          ? String(customerSig.current.toDataURL())
          : val.Customer_Signature,
        Operator_Description: values.operatorDisc,
        Operator_Signature: sigOperatorEdit
          ? String(operatorSig.current.toDataURL())
          : val.Operator_Signature,
          ...
          <form className="admitionDiv">
            ...
            <Form.Group className="mb-3">
              ...
              {!sigCustomerEdit ? (
                <div className="updateModalSig">
                  <img
                    className="imageCustomer"
                    src={props.rowValus.Customer_Signature}
                    alt=""
                  />
                  <button
                    className="editSignature"
                    onClick={(e) => setSigCustomerEdit(true)}
                  >
                    {t("admissionEdit")}
                  </button>
                </div>
            ...
            <Form.Group className="mb-3">
              ...
              {!sigOperatorEdit ? (
                <div className="updateModalSig">
                  <img
                    className="imageCustomer"
                    src={props.rowValus.Operator_Signature}
                    alt=""
                  />
                  <button
                    className="editSignature"
                    onClick={(e) => setSigOperatorEdit(true)}
                  >
                    {t("admissionEdit")}
                  </button>
                </div>
            ...
            <Form.Group className="mb-3" controlId="formBasicEmail">
              <div className="customerDescDiv">
                ...
                <textarea
                  className="customerDesc"
                  cols={30}
                  rows={10}
                  value={values.customerDisc}
                  onChange={(e) =>
                    setValues({ ...values, customerDisc: e.target.value })
                  }
                />
              </div>
            </Form.Group>
            <Form.Group className="mb-3" controlId="formBasicEmail">
              <div className="customerDescDiv">
                ...
                <textarea
                  ...
                  cols={30}
                  rows={10}
                  value={values.operatorDisc}
                  onChange={(e) =>
                    setValues({ ...values, operatorDisc: e.target.value })
                  }
                />
              </div>
            </Form.Group>

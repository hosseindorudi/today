            ...
            <div className='parentMain'>
                ...
                <div className="midle" style={{marginTop: search ? 25 : 0,maxHeight: search ? '95vh' : '100vh'}}>
                    ...
                    <div className='footerMainParent'>
                        ...
                        <div className="down">                 
                            <ul className="page">
                                <li className="page__btn"><button onClick={()=> console.log("clicked")} className="material-icons tableFooterBTN">&laquo;</button></li>
                                ...
                                <li className="page__btn"><button className="material-icons tableFooterBTN">&raquo;</button></li>
                            </ul> 
                        </div>
